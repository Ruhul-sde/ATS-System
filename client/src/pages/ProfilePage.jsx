  ...
  const loadProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Map the profile data to formData structure
        setFormData({
          personalInfo: {
          ...
          educationHistory: profile.educationHistory || {
            tenthGrade: { board: '', schoolName: '', yearOfPassing: '', percentage: '', grade: '', subjects: [] },
            twelfthGrade: { board: '', schoolName: '', stream: '', yearOfPassing: '', percentage: '', grade: '', subjects: [] },
            graduation: { degree: '', specialization: '', university: '', collegeName: '', yearOfPassing: '', cgpa: '', percentage: '', grade: '', projects: [] },
            postGraduation: { degree: '', specialization: '', university: '', collegeName: '', yearOfPassing: '', cgpa: '', percentage: '', grade: '', thesis: { title: '', description: '', guide: '' }, projects: [] },
            additionalQualifications: []
          },
          workExperienceHistory: profile.workExperienceHistory || [],
          references: profile.references || [],
          skillsAndCertifications: profile.skillsAndCertifications || {
            technicalSkills: [],
            softSkills: [],
            certifications: [],
            languages: []
          },
          resume: profile.resume || { fileName: '', fileUrl: '', fileSize: 0, uploadDate: null },
          ...
          careerPreferences: profile.careerPreferences || {
            ...
            preferredJobTypes: [],
            preferredCompanySize: '',
            salaryExpectations: { minimum: '', maximum: '', currency: 'INR', negotiable: false },
            careerGoals: '',
            willingToRelocate: false,
            availabilityToJoin: ''
          }
